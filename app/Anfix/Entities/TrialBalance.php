...
class TrialBalance extends StaticModel
{
   ...
   /**
	* Generación del balance de comprobación o balance de sumas y saldos.
	* @param array $params Parámetros
	* @param string $companyId Identificador de la empresa
	* @return Object
	*/
	public static function report(array $params,$companyId){
        $result = self::_send($params,$companyId,'trialbalance');
