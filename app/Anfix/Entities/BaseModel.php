...
class BaseModel
{
    ...
    public static function create(array $params, $companyId = null, $path = 'create')
    {
        ...
        $received_params = array_filter(get_object_vars($result->outputData->{$obj->Model}), function ($value) {
            return !is_array($value);
        }); //Parametros no array
        $received_params_arr = array_filter(get_object_vars($result->outputData->{$obj->Model}), function ($value) {
            return is_array($value);
