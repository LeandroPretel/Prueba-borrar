...
<div class="content" style="background-image: url({{ URL::asset('images/bg.png') }})">
    <div class="email-content">
        ...
        <div id="social-container">
            ...
            @if($unsubscribeUrl)
                <div id="social-unsubscribe">
                    <p>Este email se envió a la dirección <b>{{$toMail}}</b>. Si no quieres recibir más correos como</p>
                    <p>este, haz click en <a target="_blank" href="{{$unsubscribeUrl}}">Borrar subscripción</a></p>
                </div>
            @endif
        </div>
    </div>
