...
use Savitar\Auth\Mail\MailTemplate;
use Savitar\Auth\Mail\NewPasswordMail;
use Savitar\Auth\Mail\RecoveryMail;
    ...
    */
    ...
    'mailables' => [
        ...
        NewPasswordMail::class => [
            ...
            '',
            ['Haz click en Establecer contraseña y te llevaremos a un formulario para que establezcas una nueva contraseña.'],
            '',
            '#cb2b99',
            'info@redentradas.es',
            'redentradas.es'
        ...
        RecoveryMail::class => [
            ...
            '',
            ['Haz click en Restaurar contraseña y te llevaremos a un formulario para que establezcas una nueva contraseña.'],
            '',
            '#cb2b99',
            'info@redentradas.es',
            'redentradas.es'
        ...
        ConfirmMail::class => [
            ...
            '¡Bienvenido Mario!',
            '',
            ['Te has registrado en redentradas. Confirma tu email para activar tu cuenta y establecer tu contraseña.'],
            '',
            '#cb2b99',
            'info@redentradas.es',
            'redentradas.es'
